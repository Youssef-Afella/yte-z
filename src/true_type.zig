...
fn parseVertices(r: *FontReader, allocator: std.mem.Allocator) struct { []u16, []Vertex, i32 } {
...
fn notMain() !void {
    const io: std.process.Init = undefined; //Need to be passed
    ...
    r.setPosition(glyf_positions[mapping_buffer['S']]);
